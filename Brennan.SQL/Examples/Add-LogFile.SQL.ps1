    <#
    LogPath             : C:\PSlogs\abacus-vmdeploy\Abacus-vmDeploy.log
    ScriptName          : Abacus-vmDeploy
    AttachToExistingLog : FALSE
    AuditLog            : True
    AuditLogPath        : \\service02.corp\DFS\SHARES\PSAuditLogs\abacus-vmdeploy\Abacus-vmDeploy.log
