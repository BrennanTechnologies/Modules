...
function Write-Log {
	...
	process {
		...
		Write-Host $Message -InformationAction $informationAction -ForegroundColor $ForeGroundColor -InformationPreference $InformationPreference -InformationAction $informationAction
